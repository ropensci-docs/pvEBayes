...
#> ✔ Generating 10000 posterior draws... [426ms]
#> 
...
#> 
#> Running time of the general-gamma model fitting: 0.331 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (10000 signal strength posterior draws per AE-drug pair):0.4343 seconds.
#> 
