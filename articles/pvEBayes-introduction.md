...
#> ✔ Fitting general-gamma model... [269ms]
#> 
#> ℹ Generating 1000 posterior draws...
#> ✔ Generating 1000 posterior draws... [90ms]
#> 
...
#> 
#> Running time of the general-gamma model fitting: 0.2761 seconds.
...
#> ℹ Fitting general-gamma model...
#> ✔ Fitting general-gamma model... [279ms]
#> 
#> ℹ Generating 1000 posterior draws...
...
#> Estimated prior is a mixture of 18 gamma distributions.
#> 
#> Running time of the general-gamma model fitting: 0.2855 seconds.
#> Optimizer convergence: not achieved.
#> Running time for posterior draws 
#> (1000 signal strength posterior draws per AE-drug pair):0.0354 seconds.
#> 
#> Extract estimated prior parameters, discovered signals
#> and signal strength posterior draws using `summary()`.
...
#> 
#> Running time of the efron model fitting: 0.1409 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (1000 signal strength posterior draws per AE-drug pair):0.0223 seconds.
#> 
#> Extract estimated prior parameters, discovered signals
#> and signal strength posterior draws using `summary()`.
```
