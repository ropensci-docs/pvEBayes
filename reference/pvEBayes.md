...
#> (1000 signal strength posterior draws per AE-drug pair):0.0432 seconds.
#> 
...
#> 
#> Running time of the K-gamma model fitting: 0.0329 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
...
#> 
#> ℹ Generating 1000 posterior draws...
#> ✔ Generating 1000 posterior draws... [52ms]
#> 
#> Object of class 'pvEBayes'
#> 
#> efron model is fitted with hyperparameters (p = 40, c0 = 0.05).
#> 
#> Running time of the efron model fitting: 0.2055 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (1000 signal strength posterior draws per AE-drug pair):0.0643 seconds.
#> 
#> Extract estimated prior parameters, discovered signals
#> and signal strength posterior draws using `summary()`.
...
#> 
#> Running time of the GPS model fitting: 0.039 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (1000 signal strength posterior draws per AE-drug pair):0.0395 seconds.
#> 
#> Extract estimated prior parameters, discovered signals
#> and signal strength posterior draws using `summary()`.
