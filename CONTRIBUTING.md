# Contributing to pvEBayes

This outlines how to propose a change to pvEBayes. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("YihaoTancn/pvEBayes", fork = TRUE)`.
...
Code of Conduct](https://docs.ropensci.org/pvEBayes/CODE_OF_CONDUCT.md).
