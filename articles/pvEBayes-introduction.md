...
#> ✔ Fitting general-gamma model... [341ms]
#> 
#> ℹ Generating 1000 posterior draws...
#> ✔ Generating 1000 posterior draws... [95ms]
#> 
...
#> 
#> Running time of the general-gamma model fitting: 0.3506 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (1000 signal strength posterior draws per AE-drug pair):0.1955 seconds.
#> 
...
#> ℹ Fitting general-gamma model...
#> ✔ Fitting general-gamma model... [355ms]
#> 
#> ℹ Generating 1000 posterior draws...
...
#> Estimated prior is a mixture of 18 gamma distributions.
#> 
#> Running time of the general-gamma model fitting: 0.3634 seconds.
#> Optimizer convergence: not achieved.
#> Running time for posterior draws 
#> (1000 signal strength posterior draws per AE-drug pair):0.0436 seconds.
#> 
#> Extract estimated prior parameters, discovered signals
#> and signal strength posterior draws using `summary()`.
...
#> 
#> Running time of the efron model fitting: 0.1678 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (1000 signal strength posterior draws per AE-drug pair):0.0275 seconds.
#> 
#> Extract estimated prior parameters, discovered signals
#> and signal strength posterior draws using `summary()`.
```
