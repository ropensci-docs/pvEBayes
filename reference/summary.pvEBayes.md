...
#> ✔ Generating 10000 posterior draws... [401ms]
#> 
...
#> 
#> Running time of the general-gamma model fitting: 0.2604 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (10000 signal strength posterior draws per AE-drug pair):0.4072 seconds.
#> 
