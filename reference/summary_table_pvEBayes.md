...
#> ✔ Generating 100 posterior draws... [13ms]
#> 
...
#> 
#> Running time of the general-gamma model fitting: 0.329 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (100 signal strength posterior draws per AE-drug pair):0.0201 seconds.
#> 
